...
public class Main {
    public static void main(String[] args) {
        if (args[0].substring(0, 24).equals("\\src\\main\\java\\resources")) args[0] = System.getProperty("user.dir") + args[0];
        if (args[1].substring(0, 24).equals("\\src\\main\\java\\resources")) args[1] = System.getProperty("user.dir") + args[1];
        if (args[2].substring(0, 24).equals("\\src\\main\\java\\resources")) args[2] = System.getProperty("user.dir") + args[2];
        try {
